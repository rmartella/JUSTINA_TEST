"""autogenerated by genpy from planning2/GoToTaskAction.msg. Do not edit."""
import sys
...
import genpy
import planning2.msg
import std_msgs.msg

class GoToTaskAction(genpy.Message):
  _md5sum = "b51620c2acbfdc0f33c6f63e5f3b3ab7"
  _type = "planning2/GoToTaskAction"
...
"""
  ...
  _slot_types = ['planning2/GoToTaskActionGoal','planning2/GoToTaskActionResult','planning2/GoToTaskActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToTaskAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = planning2.msg.GoToTaskActionGoal()
      if self.action_result is None:
        self.action_result = planning2.msg.GoToTaskActionResult()
      if self.action_feedback is None:
        self.action_feedback = planning2.msg.GoToTaskActionFeedback()
    else:
      self.action_goal = planning2.msg.GoToTaskActionGoal()
      self.action_result = planning2.msg.GoToTaskActionResult()
      self.action_feedback = planning2.msg.GoToTaskActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3f3I.pack(_x.action_goal.goal.goal.x, _x.action_goal.goal.goal.y, _x.action_goal.goal.goal.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.goal.x, _x.action_goal.goal.goal.y, _x.action_goal.goal.goal.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
