"""autogenerated by genpy from planning2/GoToTaskActionResult.msg. Do not edit."""
import sys
...
class GoToTaskActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "planning2/GoToTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','planning2/GoToTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = planning2.msg.GoToTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = planning2.msg.GoToTaskResult()
