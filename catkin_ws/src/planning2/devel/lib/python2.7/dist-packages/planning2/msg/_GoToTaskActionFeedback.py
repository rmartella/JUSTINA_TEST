"""autogenerated by genpy from planning2/GoToTaskActionFeedback.msg. Do not edit."""
import sys
...
class GoToTaskActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "planning2/GoToTaskActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','planning2/GoToTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToTaskActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = planning2.msg.GoToTaskFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = planning2.msg.GoToTaskFeedback()
